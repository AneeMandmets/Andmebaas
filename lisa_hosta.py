...
def lisa_hosta():
    ...
    greet = Label(window, font=("arial", 20, "bold"), text="Hosta lisamine")
    greet.grid(row=0, columnspan=3)

    L = Label(window, font = ('arial', 15, 'bold'), text = "Sisesta hosta nimi: ")
    ...
    submitbtn=Button(window, text="Lisa", command=lambda:[lisa_and_hosta(), window.destroy()], bg="DodgerBlue2", fg="white", font=("arial", 15, "bold"))
